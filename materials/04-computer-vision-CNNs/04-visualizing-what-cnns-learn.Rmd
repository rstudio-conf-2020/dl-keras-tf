---
title: "Computer vision & CNNs: Visualizing what CNNs learn"
...
img_path <- here::here("docs", "data", "dogs-vs-cats", "test", "cats", "cat.1700.jpg")
...
The following will create a new subdirectory, plot the first 8 feature 
channels, and save them in the new directory.
...
Switch the image name in the following to see the plot:

```{r}
knitr::include_graphics("cat_activations/1_conv2d.png")
```
...
```{r}
knitr::include_graphics("vgg_filters/block4_conv1.png")
```