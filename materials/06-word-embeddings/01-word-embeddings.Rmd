...
the original data files which can be found at
...
weights that optimize the classification loss function. [ℹ️](http://bit.ly/dl-06#12)
...
Spend a few minutes adjusting this model and see how it impact performance. You
may want to test:
