...
Keras provides a built-in IMBD dataset `dataset_imdb()`. However, we are going
to use the original IMDB movie review files which can be found at
http://ai.stanford.edu/~amaas/data/sentiment/aclImdb_v1.tar.gz. This tends to
help students to better understand the entire data prep required for text.
