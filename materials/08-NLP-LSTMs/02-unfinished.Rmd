...
__NOTE__: This is an unfinished notebook that I have not decided whether to keep
or not. Consequently, I have not set up the data install pipeline for it in the
Requirements file.
