...
provided at <http://ai.stanford.edu/~amaas/data/sentiment> to go through
the process of importing and preparing the dataset for analysis. This
dataset has the same 50K reviews as the built-in dataset and the reviews
are separated into training (25K) and testing (25K).
