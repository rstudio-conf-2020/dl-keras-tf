...
```{r, echo=FALSE}
knitr::include_graphics("images/example_learning_curve.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://media2.giphy.com/media/pzuye8RSBJFgk/source.gif")
```
